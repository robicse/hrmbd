  ...
  <div class="login-box-body">
    ...
    <?= $this->Form->create() ?>
      <div class="form-group has-feedback">
        <?= $this->Form->input('email_or_phone',['placeholder'=>'Phone Or Email']) ?>
      ...
      <div id="CreateOrRecover" class="row">
        <div class="col-xs-6">
          <?php echo $this->Html->link('I forget my password',['action'=>'forgetPassword']) ?>
        </div>
        <div class="col-xs-6 text-right">
            <?php echo $this->Html->link('Create an account',['action'=>'register']) ?>
        </div>
      </div>
    <?= $this->Form->end() ?>
  </div>
