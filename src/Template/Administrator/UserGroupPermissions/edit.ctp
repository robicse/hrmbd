            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary no-border">
                    <div class="box-header with-border">
                      <h3 class="box-title"><?= __('Edit User Group Permission') ?></h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    ...
                    <?php
                        ...
                        echo $this->Form->input('user_group_controller_id', ['options' => $userGroupControllers]);
                        echo $this->Form->input('user_group_controller_action_id', ['options' => $userGroupControllerActions]);
                    ?>
