      ...
      <div class="col-xs-12">
        ...
        <div class="box no-border">
          <div class="box-header">
            <h3 class="box-title">
              <?= $this->Html->link(__('<i class="fa fa-plus-circle"></i> Add New Bank Branchs'), [
                    'action' => 'add'
                  ],[
        ...
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover table-bordered">
            <tr class="custom-table-header">
              ...
              <th class="text-center"><?= $this->Paginator->sort('bank_id') ?></th>
            ...
            <?php foreach ($bankBranchs as $bankBranch): ?>
              <tr>
                ...
                <td class="text-center">
                  <?php if($bankBranch->status == 'active'){ ?>
                ...
                <?= $this->Html->link(__('<i class="fa  fa-eye"></i>'), ['action' => 'view', $bankBranch->id],['class'=>'label label-success','escape'=>false]) ?>
                <?= $this->Html->link(__('<i class="fa  fa-edit"></i>'), ['action' => 'edit', $bankBranch->id],['class'=>'label label-info','escape'=>false]) ?>
                <?= $this->Form->postLink(__('<i class="fa  fa-close"></i>'), ['action' => 'delete', $bankBranch->id], ['class'=>'label bg-red','confirm' => __('Are you sure you want to delete # {0}?', $bankBranch->id),'escape'=>false]) ?>
                </td>
              </tr>
            <?php endforeach; ?>
            </table>
