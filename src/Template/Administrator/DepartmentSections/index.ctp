      ...
      <div class="col-xs-12">
        ...
        <div class="box no-border">
          <div class="box-header">
            <h3 class="box-title">
              <?= $this->Html->link(__('<i class="fa fa-plus-circle"></i> Add New Department Sections'), [
                    'action' => 'add'
                  ],[
            ...
            <?php foreach ($departmentSections as $departmentSection): ?>
              <tr>
                ...
                <td class="text-center">
                  <?php if($departmentSection->status == 'active'){ ?>
                ...
                <?= $this->Html->link(__('<i class="fa  fa-eye"></i>'), ['action' => 'view', $departmentSection->id],['class'=>'label label-success','escape'=>false]) ?>
                <?= $this->Html->link(__('<i class="fa  fa-edit"></i>'), ['action' => 'edit', $departmentSection->id],['class'=>'label label-info','escape'=>false]) ?>
                <?= $this->Form->postLink(__('<i class="fa  fa-close"></i>'), ['action' => 'delete', $departmentSection->id], ['class'=>'label bg-red','confirm' => __('Are you sure you want to delete # {0}?', $departmentSection->id),'escape'=>false]) ?>
                </td>
              </tr>
            <?php endforeach; ?>
            </table>
