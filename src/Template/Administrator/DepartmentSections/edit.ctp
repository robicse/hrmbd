            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary no-border">
                    <div class="box-header with-border">
                      <h3 class="box-title"><?= __('Edit Department Section') ?></h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <?= $this->Form->create($departmentSection) ?>
                    <?php
                        echo $this->Form->input('department_id', ['options' => $departments,'empty'=>'--Select Department--']);
