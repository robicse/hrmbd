        ...
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover table-bordered">
            <tr class="custom-table-header">
              ...
              <th class="text-center"><?= $this->Paginator->sort('left_sidebar') ?></th>
              <th class="text-center"><?= $this->Paginator->sort('dashboard') ?></th>
            ...
            <?php foreach ($userGroupMenus as $userGroupMenu): ?>
              <tr>
                ...
                <td class="text-center">
                  <i class="<?= h($userGroupMenu->menu_icon) ?>"></i>
                </td>
                <td class="text-center">
                  <?php if ($userGroupMenu->left_sidebar) { ?>
                ...
                <td class="text-center">
                  <?php if ($userGroupMenu->dashboard) { ?>
                    <i class="fa fa-check-square"></i>
                  <?php }else{ ?>
                    <i class="fa fa-times-circle"></i>
                  <?php } ?>
                ...
                <?= $this->Html->link(__('<i class="fa  fa-eye"></i>'), ['action' => 'view', $userGroupMenu->id],['class'=>'label label-success','escape'=>false]) ?>
                <?= $this->Html->link(__('<i class="fa  fa-edit"></i>'), ['action' => 'edit', $userGroupMenu->id],['class'=>'label label-info','escape'=>false]) ?>
                <?= $this->Form->postLink(__('<i class="fa  fa-close"></i>'), ['action' => 'delete', $userGroupMenu->id], ['class'=>'label bg-red','confirm' => __('Are you sure you want to delete # {0}?', $userGroupMenu->id),'escape'=>false]) ?>
                </td>
              </tr>
            <?php endforeach; ?>
            </table>
