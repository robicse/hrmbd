            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary no-border">
                    <div class="box-header with-border">
                      <h3 class="box-title"><?= __('Edit User Group Menu') ?></h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <?= $this->Form->create($userGroupMenu) ?>
                    <?php
                        echo $this->Form->input('user_group_id', ['options' => $userGroups]);
                        echo $this->Form->input('title');
                        echo $this->Form->input('menu_icon');
                        echo $this->Form->input('left_sidebar',[
                            'options'=>[
                                '0'=>'No',
                                '1'=>'Yes'
                            ]
                        ...
                        echo $this->Form->input('action',['options'=>[''=>'Select Action']]);
                    ?>
...
<?php
    echo $this->Html->script('user-group-menu-add',['block'=>'footerScript']);
?>