            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary no-border">
                    <div class="box-header with-border">
                      <h3 class="box-title"><?= __('Edit Leave Package') ?></h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <?= $this->Form->create($leavePackage) ?>
                    <?php
                        echo $this->Form->input('title');
                        echo $this->Form->input('casual');
                        echo $this->Form->input('sick');
                        echo $this->Form->input('earned');
