       ...
       <div class="col-md-12">
            <div class="box box-primary no-border">
                <div class="box-body no-padding">
                    <h3 class="text-center"><?= h($leaveCategory->title) ?></h3>
       ...
       <div class="col-md-12">
            <div class="box box-primary no-border">
                <div class="box-body no-padding">
                    ...
                    <?php if (!empty($leaveCategory->user_leaves)): ?>
                    <div class="table-responsive">
                        <table class="table table-striped">
                    ...
                    <?php foreach ($leaveCategory->user_leaves as $userLeaves): ?>
                            <tr>
