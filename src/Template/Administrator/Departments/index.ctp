      ...
      <div class="col-xs-12">
        ...
        <div class="box no-border">
          <div class="box-header">
            <h3 class="box-title">
              <?= $this->Html->link(__('<i class="fa fa-plus-circle"></i> Add New Departments'), [
                    'action' => 'add'
                  ],[
          ...
          <table class="table table-hover table-bordered">
            ...
            <?php foreach ($departments as $department): ?>
              <tr>
                ...
                <?= $this->Html->link(__('<i class="fa  fa-eye"></i>'), ['action' => 'view', $department->id],['class'=>'label label-success','escape'=>false]) ?>
                <?= $this->Html->link(__('<i class="fa  fa-edit"></i>'), ['action' => 'edit', $department->id],['class'=>'label label-info','escape'=>false]) ?>
                <?= $this->Form->postLink(__('<i class="fa  fa-close"></i>'), ['action' => 'delete', $department->id], ['class'=>'label bg-red','confirm' => __('Are you sure you want to delete # {0}?', $department->id),'escape'=>false]) ?>
                </td>
              </tr>
            <?php endforeach; ?>
            </table>
