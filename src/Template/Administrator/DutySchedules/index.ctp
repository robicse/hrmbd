      ...
      <div class="col-xs-12">
        ...
        <div class="box no-border">
          <div class="box-header">
            <h3 class="box-title">
              <?= $this->Html->link(__('<i class="fa fa-plus-circle"></i> Add New Duty Schedules'), [
                    'action' => 'add'
                  ],[
        ...
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover table-bordered">
            <tr class="custom-table-header">
              ...
              <th class="text-center"><?= $this->Paginator->sort('late_time') ?></th>
              <th class="text-center"><?= $this->Paginator->sort('end_time') ?></th>
            ...
            <?php foreach ($dutySchedules as $dutySchedule): ?>
              <tr>
                ...
                <?= $this->Html->link(__('<i class="fa  fa-eye"></i>'), ['action' => 'view', $dutySchedule->id],['class'=>'label label-success','escape'=>false]) ?>
                <?= $this->Html->link(__('<i class="fa  fa-edit"></i>'), ['action' => 'edit', $dutySchedule->id],['class'=>'label label-info','escape'=>false]) ?>
                <?= $this->Form->postLink(__('<i class="fa  fa-close"></i>'), ['action' => 'delete', $dutySchedule->id], ['class'=>'label bg-red','confirm' => __('Are you sure you want to delete # {0}?', $dutySchedule->id),'escape'=>false]) ?>
                </td>
              </tr>
            <?php endforeach; ?>
            </table>
