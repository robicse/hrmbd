      ...
      <div class="col-xs-12">
        ...
        <div class="box no-border">
          <div class="box-header">
            <h3 class="box-title">
              <?= $this->Html->link(__('<i class="fa fa-plus-circle"></i> Add New Employee Types'), [
                    'action' => 'add'
                  ],[
            ...
            <?php foreach ($employeeTypes as $employeeType): ?>
              <tr>
                ...
                <td class="text-center">
                  <?php if($employeeType->status == 'active'){ ?>
                ...
                <?= $this->Html->link(__('<i class="fa  fa-eye"></i>'), ['action' => 'view', $employeeType->id],['class'=>'label label-success','escape'=>false]) ?>
                <?= $this->Html->link(__('<i class="fa  fa-edit"></i>'), ['action' => 'edit', $employeeType->id],['class'=>'label label-info','escape'=>false]) ?>
                <?= $this->Form->postLink(__('<i class="fa  fa-close"></i>'), ['action' => 'delete', $employeeType->id], ['class'=>'label bg-red','confirm' => __('Are you sure you want to delete # {0}?', $employeeType->id),'escape'=>false]) ?>
                </td>
              </tr>
            <?php endforeach; ?>
            </table>
